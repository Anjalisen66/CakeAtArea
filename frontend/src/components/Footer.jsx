...
<div className="upperfooter">
        ...
        <h1>Our Team</h1>
         <ul><li>Our Mentor: Rishabh Sir</li> 
            ...
            <li> Anuj Mathur: Anuj had given his valuable contribution to website crafting a seamless and visually stunning user experience, turning design concepts into interactive reality.</li> 
